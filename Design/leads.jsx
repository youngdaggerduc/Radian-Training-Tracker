// Leads, Follow-ups, Detail Drawer
const RD = window.RADIAN;

// ============ LEADS TABLE ============
function LeadsView({ state, openDrawer, openModal }) {
...
// ============ FOLLOW-UPS VIEW ============
function FollowUpsView({ state, openDrawer, openModal, updateLead }) {
...
// ============ LEAD DETAIL DRAWER ============
function LeadDrawer({ lead, onClose, updateLead, convertToTrainee, openModal }) {
